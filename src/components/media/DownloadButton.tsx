  ...
  if (status === "downloaded") {
    return (
      <button
        ...
        title="Disponível offline — clique para remover"
        className="flex h-9 w-9 items-center justify-center rounded-full bg-status-success/10 text-status-success hover:bg-status-error/10 hover:text-status-error"
      >
